          ...
          <section className={styles.content}>
            ...
            <div className={`${styles.content__color} ${styles.green}`}>
              <div>
                ...
                <span>2</span>
                <p>
                  Samen met DURF 2030 en andere gebruikers zullen we jou project
                  laten groeien en helpen met je benodigdheden om je project te
                  realiseren.
                </p>
                <span>3</span>
                <p>
          ...
          <section className={styles.content}>
            ...
            <div className={`${styles.content__color} ${styles.yellow}`}>
              <div>
                <span>1</span>
                <p>
                  Wil je een handje helpen? Zoek naar bestaand projecten op het
                  platform.
                </p>
                <span>2</span>
                <p>
                  Ieder project heeft een lijst van benodigdheden waar jij als
                  durver op kan in spelen.
                </p>
                <span>3</span>
                <p>
